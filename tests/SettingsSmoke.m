...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)options {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, 2 * NSEC_PER_SEC), dispatch_get_main_queue(), ^{
        ...
        BOOL passed = screen != nil && screen.tableView.numberOfSections == 2 &&
            [screen.tableView numberOfRowsInSection:0] == 5 && [screen.tableView numberOfRowsInSection:1] == 1;
        ...
        passed &= screen.positionSlider.window != nil && screen.positionSlider.bounds.size.width > 100;
        NSIndexPath *githubPath = [NSIndexPath indexPathForRow:0 inSection:1];
        ...
        NSString *report = passed ? @"PASS: visible settings table, slider, up/down, reset, persistence and GitHub row" : @"FAIL";
